  ...
  return (
    <>
      <View style={tw`flex flex-col justify-start items-center gap-2 bg-white`}>
        ...
        <View style={tw`flex flex-row justify-center items-center bg-[#F5F7F9]`}>
          <Text>UShift Answers</Text>
      ...
      <View style={tw`flex flex-row justify-center items-center`}>
        <Text style={tw.style({ fontFamily: 'DMSans_18pt-Light' }, 'text-center text-[#4A4A68]')}>
