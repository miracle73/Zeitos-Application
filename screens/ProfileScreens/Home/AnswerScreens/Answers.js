  ...
  return (
    <>
      <SafeAreaView style={{marginTop: Constants.statusBarHeight}}>
        <View style={tw`flex flex-col justify-start items-center gap-2 bg-white`}>
          <Ionicons name="chevron-back" size={24} color={"#141414"} onPress={() => navigation.goBack("Account")} />
          <View style={tw`flex flex-row justify-between items-center bg-[#F5F7F9]`}>
            <Pressable style={tw`w-[170px] h-[30px] justify-center rounded-lg ${buttonOne ? 'bg-white' : 'bg-gray-200'}`} onPress={handleButtonOne}>
              <Text style={tw.style({ fontFamily: 'DMSans_18pt-Medium.ttf' }, 'text-center')}>UShift Answers</Text>
            </Pressable>
            <Pressable style={tw`w-[170px] h-[30px] justify-center rounded-lg ${buttonTwo ? 'bg-white' : 'bg-gray-200'}`} onPress={handleButtonTwo}>
              <Text style={tw.style({ fontFamily: 'DMSans_18pt-Medium.ttf' }, 'text-center')}>My Answers</Text>
            </Pressable>
          </View>
        </View>
        <View>
          <Text style={tw.style({ fontFamily: 'DMSans_18pt-Medium.ttf' }, 'text-[#141414] text-base')}>Answered Scenario</Text>
          <Text style={tw.style({ fontFamily: 'DMSans_18pt-Medium.ttf' }, 'text-[#141414] text-base')}></Text>
        </View>
        ...
        <View style={tw`flex flex-row justify-center items-center`}>
          <Text style={tw.style({ fontFamily: 'DMSans_18pt-Light.ttf' }, 'text-center text-[#4A4A68]')}>
