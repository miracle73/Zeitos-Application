                ...
                <View style={tw`flex justify-start items-start bg-[#f5f7ff] gap-4 h-full p-4`}>
                    ...
                    <View style={tw`flex justify-center items-start bg-white rounded-lg h-[230px] w-[100%] p-2`}>
                        <View style={tw`flex flex-row justify-start items-start gap-2`}>
                            <Text style={tw.style({ fontFamily: 'DMSans_18pt-Medium.ttf' }, 'text-base text-white rounded-lg bg-[#3e8e7b] text-center px-4')}>2</Text>
                    ...
                    <View style={tw`flex flex-row justify-between items-center gap-18 rounded-lg bg-white p-4`}>
                        <Text style={tw.style({ fontFamily: 'DMSans_18pt-Medium.ttf' }, 'text-black text-center')} onPress={() => navigation.navigate("AddQuestion2")}>Save as a Draft</Text>
                        <CustomButton style={tw`flex flex-row justify-between items-center bg-[#001c46] rounded-lg px-4 py-3`} onPress={() => navigation.navigate("Question3")}>
