            ...
            <SafeAreaView style={{ marginTop: Constants.statusBarHeight }}>
                <ScrollView vertical>
                    <View style={tw`flex justify-start items-start bg-[#f5f7ff] gap-4 h-full`}>
                        ...
                        <View style={tw`p-4`}>
                            <View style={tw`flex justify-center items-start gap-12 bg-white gap-12 rounded-lg h-[230px] w-[358px] py-12`}>
                                <View>
                                ...
                                <View style={tw`mt-18 flex justify-center items-start`}>
                            ...
                            <View style={tw`flex flex-row justify-between items-center gap-18 rounded-lg bg-white p-4`}>
                                <Text style={tw.style({ fontFamily: 'DMSans_18pt-Medium.ttf' }, 'text-black text-center')} onPress={() => navigation.navigate("AddQuestion3")}>Save as a Draft</Text>
                                <CustomButton style={tw`flex flex-row justify-between items-center bg-[#001c46] rounded-lg px-4 py-3`} onPress={() => navigation.navigate("Question4")}>
