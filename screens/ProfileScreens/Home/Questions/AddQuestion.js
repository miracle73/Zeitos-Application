            ...
            <SafeAreaView style={{ marginTop: Constants.statusBarHeight }}>
                <ScrollView vertical>
                    <View style={tw`flex justify-start items-start bg-[#f5f7ff] gap-4 h-full p-4`}>
                        ...
                        <View style={tw`flex justify-center items-start gap-12 bg-white rounded-lg h-[230px] w-[100%] p-2`}>
                            <View>
                    ...
                    {/* <View style={tw`flex flex-row justify-between items-center bg-white`}>
          <Text style={tw.style({fontFamily: 'DMSans_18pt-Medium.ttf'}, 'text-black text-center')}>Save as a Draft</Text>
          <CustomButton style={tw`flex flex-row justify-between items-center bg-[#001c46] rounded-lg px-4 py-3`}>
