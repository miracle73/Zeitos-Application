          ...
          <View style={tw`flex justify-start items-start bg-[#f5f7ff] gap-4 h-full`}>
            ...
            <View style={tw`p-4`}>
              ...
              <View style={tw`flex flex-col justify-center items-start gap-2 bg-white rounded-lg p-4 w-[100%]`}>
                ...
                <CustomInput multiline={true} numberOfLines={5} textAlignVertical="top" placeholder="Write solution here" placeholderText={"#8c8ca1"} style={tw`border-2 border-[#F5F7F9] bg-[#F5F7F9] p-2.5 rounded-lg min-w-full`} />
              </View>
