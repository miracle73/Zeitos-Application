                ...
                <View style={tw`flex justify-start items-start gap-4 bg-[#F5F7FF] min-h-full`}>
                    <View style={tw`flex justify-start items-start gap-4 bg-white w-full p-4`}>
                        ...
                        <View style={tw`flex justify-start items-start gap-2`}>
                            <Text style={tw.style({ fontFamily: 'DMSans_18pt-Medium.ttf' }, 'text-3xl text-[#141414]')}>Scenarios 1</Text>
                    ...
                    <View style={tw`flex flex-row justify-end items-end gap-12 rounded-lg bg-white min-w-full p-4 h-20`}>
                        <CustomButton style={tw`flex flex-row justify-between items-center bg-[#001c46] rounded-lg px-4 py-3`} onPress={() => navigation.navigate("Score")}>
                            <Text style={tw.style({ fontFamily: 'DMSans_18pt-Medium.ttf' }, 'text-base text-white')}>Submit</Text>
...
export default SubmitScenarios