  ...
  return (
    <>
      <SafeAreaView style={{ marginTop: Constants.statusBarHeight }}>
        <ScrollView vertical>
          <View style={tw`flex flex-col justify-center items-start gap-6 p-4`}>
          <View style={tw`flex flex-col justify-start items-start gap-2 bg-white`}>
          ...
          <View style={tw`flex flex-row justify-center items-center`}>
            <Text style={tw.style({ fontFamily: 'DMSans_18pt-Light.ttf' }, 'text-left text-[#4A4A68]')}>
